...
ActiveRecord::Schema.define(version: 20180222140659) do
  ...
  create_table "candidates_skills", force: :cascade do |t|
    ...
    t.index ["candidate_id", "skill_id"], name: "index_candidates_skills_on_candidate_id_and_skill_id", unique: true
  ...
  create_table "projects_skills", force: :cascade do |t|
    ...
    t.integer "skill_id"
    t.index ["project_id", "skill_id"], name: "index_projects_skills_on_project_id_and_skill_id", unique: true
